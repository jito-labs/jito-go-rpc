...
type JSONRPCClient interface {
	...
	CallBatch(ctx context.Context, path string, requests jsonrpc.RPCRequests) (jsonrpc.RPCResponses, error)
	Close() error
}
...
func (cl *Client) RPCCallForInto(ctx context.Context, out any, path string, method string, params []any) error {
	return cl.rpcClient.CallForInto(ctx, out, path, method, params)
}
...
func (cl *Client) RPCCallWithCallback(
	...
	return cl.rpcClient.CallWithCallback(ctx, path, method, params, callback)
}
...
func (cl *Client) RPCCallBatch(
	...
	return cl.rpcClient.CallBatch(ctx, path, requests)
}
